...
cur.execute("SELECT gramID FROM winnowedGram")
...
while idRow is not None:
    ...
    print ids
    idRow = cur.fetchone()
file = open("C:/UMD/Research/CountGramTweetResults/CountGramTweet(Winnow)3.txt", 'at')

for w in range(30000, len(tweetPhrases)):
    dbWord = []
